...
"21.Başkalarına ihtiyacım olabileceğini öğrendim."
  ...
  return (
    ...
    <div className="container">
            <div>
        <p>Aşağıda yaşadığınız stresten dolayı yaşamınızda olabilecek bazı değişiklikler verilmektedir. Her cümleyi dikkatle okuyunuz ve belirtilen değişikliğin sizin için ne derece gerçekleştiğini aşağıdaki ölçeği kullanarak belirtiniz.</p>
        ...
        <p>4= Yaşadığım stresten dolayı oldukça fazla derecede değişiklik yaşadım.</p>
